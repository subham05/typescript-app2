export default {
  ...
  nameError: 'General manager name is required',
  nameError_2: 'General manager name is not valid',
  nameError_3: 'General manager name must be at least 3 characters',
  nameError_4: 'General manager name must be at most 100 characters',
