...
export const AddCompanyScreen = (props: Props) => {
  ...
  useEffect(() => {
    if (deleteCompanySuccess && deleteCompanyData) {
      const {message} = deleteCompanyData;
        ...
        return (
          <Container noSpacing>
            <Header
              ...
              // RenderLeftContainer={isEdit ? renderLeftContainer : undefined}
            />
            ...
            {(loader || deleteCompanyIsLoading) && <Loader />}
            <ImageView
