...
import {VendorSuppliersItem} from 'screens/Vendors-Suppliers/components/Vendors-SuppliersItem';
...
export const VendorSuppliersList: React.FC<VendorSuppliersListProps> = ({
  data,
  isLoading,
  isFetching,
  refreshing,
      ...
      <FlatList
        ...
        renderItem={({item, index}) => (
          <View key={index} style={styles().container}>
            <VendorSuppliersItem data={item} onPress={onPress} />
          </View>
        )}
